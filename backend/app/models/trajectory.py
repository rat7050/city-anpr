...
class Trajectory(Base):
    ...
    vehicle_id: Mapped[uuid.UUID] = mapped_column(UUIDType(), ForeignKey('vehicles.id'), nullable=False)
    ...
    route_geometry: Mapped[str] = mapped_column(GeometryText(), nullable=True)
